...
public class mainClass {
    public static String wordChecker (String word1, String word2){
        String result = "";
        String [] word1CheckStrings = { word1.substring(0,1),word1.substring(1,2),word1.substring(2,3),word1.substring(3,4),word1.substring(4)};
        String [] word2CheckStrings = { word2.substring(0,1),word2.substring(1,2),word2.substring(2,3),word2.substring(3,4),word2.substring(4)};

    for(int i = 0; i < 5; i++){
        for(int k = 0; k < 5; k++){
            if (word1CheckStrings[i].equals(word2CheckStrings[i])) {
                result = result + word1CheckStrings[i];
                break;
            } else {
                if(!word1CheckStrings[i].equals(word2CheckStrings[i])){
                    result = result + "-";
